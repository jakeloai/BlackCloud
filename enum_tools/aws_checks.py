...
AWS_REGIONS = [
    # 北美 (North America)
    'us-east-1.amazonaws.com',   # N. Virginia
    'us-east-2.amazonaws.com',   # Ohio
    'us-west-1.amazonaws.com',   # N. California
    'us-west-2.amazonaws.com',   # Oregon
    ...
    # 南美 (South America)
    'sa-east-1.amazonaws.com',   # São Paulo

    # 歐洲 (Europe)
    'eu-central-1.amazonaws.com',# Frankfurt
    'eu-central-2.amazonaws.com',# Zurich
    'eu-west-1.amazonaws.com',   # Ireland
    'eu-west-2.amazonaws.com',   # London
    'eu-west-3.amazonaws.com',   # Paris
    'eu-north-1.amazonaws.com',  # Stockholm
    'eu-south-1.amazonaws.com',  # Milan
    'eu-south-2.amazonaws.com',  # Spain

    # 亞太地區 (Asia Pacific)
    'ap-northeast-1.amazonaws.com', # Tokyo
    'ap-northeast-2.amazonaws.com', # Seoul
    'ap-northeast-3.amazonaws.com', # Osaka
    'ap-southeast-1.amazonaws.com', # Singapore
    'ap-southeast-2.amazonaws.com', # Sydney
    'ap-southeast-3.amazonaws.com', # Jakarta
    'ap-southeast-4.amazonaws.com', # Melbourne
    'ap-southeast-5.amazonaws.com', # Malaysia
    'ap-southeast-6.amazonaws.com', # New Zealand
    'ap-southeast-7.amazonaws.com', # Thailand
    'ap-south-1.amazonaws.com',     # Mumbai
    'ap-south-2.amazonaws.com',     # Hyderabad
    'ap-east-1.amazonaws.com',      # Hong Kong

    # 中東與非洲 (Middle East & Africa)
    'me-south-1.amazonaws.com',   # Bahrain
    'me-central-1.amazonaws.com', # UAE
    'il-central-1.amazonaws.com', # Israel (Tel Aviv)
    'af-south-1.amazonaws.com',   # Cape Town

    # 中國區域 (China - 特殊網域)
    'cn-north-1.amazonaws.com.cn',    # Beijing
    'cn-northwest-1.amazonaws.com.cn' # Ningxia
]
